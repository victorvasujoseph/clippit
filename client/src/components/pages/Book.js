...
import { form, Card, CardGroup, Button, ListGroup, Modal, Row, Form, Col } from "react-bootstrap";
...
<Col sm="6">
        ...
        <br></br>
        <br></br>
        <Modal show={this.state.visible} onExited={this.handleOff}>
          <form onSubmit={this.handleToggleClick}>
            <label>
              Pick your time &nbsp;&nbsp;
